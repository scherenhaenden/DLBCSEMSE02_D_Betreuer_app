...
| **Student**    | mein Zweitgutachter suchen                          | Dashboard-Schalter „Zweitgutachter“        | ❌         | `view_dashboard_student.xml` enthält UI-Element **[Gemacht (UI)]** |
| **Student**    | Zweitgutachter bestätigen                           | `SecondSupervisorFragment`                 | ❌         | **Kein UI-Element, keine Logik gefunden** **[Fehlt]**     |
